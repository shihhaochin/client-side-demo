...
const Experience = ({
  ...
  let [experienceArticle, setExperienceArticle] = useState(null);
  ...
  useEffect(() => {
    articleService
      ...
      .then((data) => {
        ...
        setExperienceArticle(data.data);
      })
      .catch((err) => {
        console.log(err);
      });
  }, [experienceArticle, setLoading]);
