...
const MedicalTalk = ({
  ...
  let [medicalTalkArticle, setMedicalTalkArticle] = useState(null);
  ...
  useEffect(() => {
    articleService
      ...
      .then((data) => {
        ...
        setMedicalTalkArticle(data.data);
      })
      .catch((err) => {
        console.log(err);
      });
  }, [medicalTalkArticle, setLoading]);
  ...
  return (
    <div className="allArticleBackground" id="allArticleBackground">
      ...
      {currentUser &&
        medicalTalkArticle &&
        loading === false &&
        medicalTalkArticle !== 0 && (
          <div className="allArticleContainer">
            {medicalTalkArticle.map((article) => (
